...
def generate_answers(question: str, answer: str, _: str) -> bool | str:
    try:
        ...
        return (fractions.Fraction(numerator1, denominator1) + fractions.Fraction(numerator2, denominator2)).numerator == answer_numerator and (fractions.Fraction(numerator1, denominator1) + fractions.Fraction(numerator2, denominator2)).denominator == answer_denominator
